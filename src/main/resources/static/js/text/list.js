...
//     const prevLink = document.createElement('a');
//     prevLink.classList.add('page-link');
//     prevLink.href = `/text/list?page=${pagination.page - 1}&genreType=${pagination.genreType}&keyword=${pagination.keyword || ''}`;
//     prevLink.innerText = '이전';
//     prevLi.appendChild(prevLink);
//     paginationContainer.appendChild(prevLi);
//
...
//     const nextLink = document.createElement('a');
//     nextLink.classList.add('page-link');
//     nextLink.href = `/text/list?page=${pagination.page + 1}&genreType=${pagination.genreType}&keyword=${pagination.keyword || ''}`;
//     nextLink.innerText = '다음';
//     nextLi.appendChild(nextLink);
//     paginationContainer.appendChild(nextLi);
// }
