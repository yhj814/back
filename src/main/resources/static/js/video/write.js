...
document.addEventListener("DOMContentLoaded", function () {
    ...
    //     inputElement.addEventListener("keydown", function (event) {
    //         // Backspace, Delete, Tab, 화살표 키는 무시
    //         if (
    //             event.keyCode === 8 || // Backspace
    //             event.keyCode === 46 || // Delete
    //             event.keyCode === 9 || // Tab
    //             (event.keyCode >= 37 && event.keyCode <= 40) // 화살표 키
    //         ) {
    //             return;
    //         }
    //
    ...
    // }
    //
    // // 'postTitle' 입력 필드 길이 제한
    // const postTitleInput = document.querySelector('input[name="postTitle"]');
    // if (postTitleInput) {
    //     limitInputLength(postTitleInput, 25);
    // }
    //
    // // 'fileContent' 입력 필드 길이 제한
    // function applyLimitToFileContentInputs() {
    //     const fileContentInputs = document.querySelectorAll('input[name="fileContent"]');
    //     fileContentInputs.forEach(function (input) {
    //         limitInputLength(input, 25);
    //     });
    // }
    //
    // // 처음 로드 시 적용
    // applyLimitToFileContentInputs();
    //
    // 'workPrice' 입력 필드 길이 및 값 제한
